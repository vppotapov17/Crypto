...
public class Cooler extends Component{
    ...
    @Ignore
    private List<String> supportSockets;                                                            // совместимость с сокетами
    ...
    public List<String> getSupportSockets() {
    ...
    public void setSupportSockets(List<String> supportSockets) {
